...
export const PLANE_SCENE_ATMOSPHERE_NAME: string = 'Plane Scene Atmosphere'
 ...
 * Errors Messages.
 */
export const SAFARI_ERROR_MESSAGE: string =
   'Earth 3D is not available on Safari for the moment. Please use another browser.'
