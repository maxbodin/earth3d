 ...
 * PNG.
 */
export const HYPTIC_TEXTURE_PNG: string =
   '/textures/png/alpha/hiptyc_2020_4k_gal_alpha_compressed.png'
export const CONSTELLATION_FIGURES_TEXTURE_PNG: string =
   '/textures/png/alpha/constellation_figures_4k_gal_alpha_compressed.png'
export const CONSTELLATION_BOUNDS_PNG: string =
   '/textures/png/alpha/constellation_bounds_4k_gal_alpha_compressed.png'
export const MILKY_WAY_PNG: string =
   '/textures/png/milkyway_2020_4k_gal-min_compressed.png'
