...
export function ToastProvider({ children }: { children: ReactNode }) {
    const [dangerToastIsDisplayed, setDangerToastIsDisplayed] = useState<boolean>(false);
    const [successToastIsDisplayed, setSuccessToastIsDisplayed] = useState<boolean>(false);
