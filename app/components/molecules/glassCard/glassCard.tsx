...
export function GlassCard({
   ...
   return (
      ...
      >
         {centered ? (
            <div
               className="w-fit max-w-screen-xl max-h-screen rounded-xl bg-white/20 bg-opacity-40 backdrop-blur-md drop-shadow-lg ring-1 ring-black/5 z-40 m-8">
               <div className="p-4">
            ...
            <div
               className="absolute top-1/2 right-10 transform -translate-y-1/2 z-40 isolate aspect-video w-96 h-[46rem] rounded-xl bg-white/20 bg-opacity-40 backdrop-blur-md drop-shadow-lg ring-1 ring-black/5">
               <CloseButton
