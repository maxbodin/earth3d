...
export function ToastDanger({
   ...
   return (
      <div
         id="toast-danger"
         className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center w-full max-w-xl p-4 mb-4 text-white bg-red-700/20 bg-opacity-40 backdrop-blur-md drop-shadow-lg ring-1 ring-black/5 rounded-lg shadow z-50"
         role="alert"
      >
         <div
