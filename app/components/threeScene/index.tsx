...
export function ThreeScene({ data, onPlaneClick }: { data: any[],onPlaneClick: (data: Record<string, any>) => void; }) {
    ...
    const setupRendererSceneCamera = () : void => {
        ...
        // Initialize camera.
        camera.current = new THREE.PerspectiveCamera(75, window.innerWidth / window.innerHeight, 0.001, 10000);
    ...
    const setupControls: () => void = () : void => {
        ...
        controls.current.minDistance = 5.1;
        ...
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
            <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
                ...
                <PlanetProvider>
                    ...
                    <Planes data={data} scene={scene.current} camera={camera.current}
