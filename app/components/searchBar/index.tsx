...
export function SearchBar({ onSearch }: { onSearch: (filteredData: string) => void }) {
    ...
    <form
        ...
        <div className="relative">
            ...
            <button
                type="submit"
                className="text-gray-800 hover:text-white absolute end-2.5 bottom-2.5 bg-gray-600 hover:bg-gray-700 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-4 py-2">
                Search
            </button>
        </div>
    </form>
